...
const isArray = (s, d) => s.type === 'Array' && d instanceof Array;
const isObject = (s, d) => s.type === 'Object' && d instanceof Object;
const isString = (s, d) => s.type === 'String' && (d instanceof String || typeof d === 'string');
const isNumber = (s, d) => s.type === 'Number' && (d instanceof Number || typeof d === 'number');
